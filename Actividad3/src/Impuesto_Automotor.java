...
public class Impuesto_Automotor {
			...
			if (valorPatente < 1000000) {
				...
				recaudado5 = calculaRecaudado(impPagado,recaudado5);
					...
					if ((valorPatente > 1000000) && (valorPatente < 2000000)) {
						...
						recaudado10 = calculaRecaudado(impPagado,recaudado5);
							...
							recaudado15= calculaRecaudado(impPagado, recaudado5);
							}
	...
	public static double calculaRecaudado(double impPagado, double recaudado5) { // calcula la recaudacion total que obtuvo el registro por porcentaje
					
			return recaudado5 += impPagado  ;
	}
